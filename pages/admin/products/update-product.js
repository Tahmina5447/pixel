      ...
      <div className="mid-container">
        ...
        >
          ...
          <div className="block md:flex items-center gap-5 mb-4">
            ...
            >
              ...
              {categories2?.data?.result?.map((item) => (
                <option key={item.parent_category} value={item.parent_category}>
          ...
          <div className="block md:flex items-center gap-5 mb-4">
            ...
            >
              <option value="" disabled>Select First Child Category</option>
              {subCategoryItem?.map((item) => (
                <option key={item.firstChildTitle} value={item.firstChildTitle}>
